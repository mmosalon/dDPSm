...
namespace dDPSm
{
    public partial class MainWindow : Window
    {
        ...
        private async Task SkillsLoad()
        {
            ...
            {
                MessageBox.Show("skills.csvが存在しません。\n全ての最大ダメージはUnknownとなります。", "dDPSm Setup", MessageBoxButton.OK, MessageBoxImage.Information);
            }
        ...
        private void HotKeyLoad()
        {
            ...
            {
                MessageBox.Show("dDPSmはホットキーを初期化出来ませんでした。　多重起動していないか確認して下さい！\nプログラムは引き続き使用できますが、ホットキーは反応しません。", "dDPSm Setup", MessageBoxButton.OK, MessageBoxImage.Information);
            }
        }
