...
namespace dDPSm
{
    ...
    public partial class SettingWindow : Window
    {
        ...
        private void OpenAppData(object sender, RoutedEventArgs e) => Process.Start(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + @"/dDPSm/");
        ...
        private void AppData_MouseEnter(object sender, System.Windows.Input.MouseEventArgs e) =>
            Description.Text = "設定をリセットする場合はdDPSmを終了させてからuser.configを削除して下さい\nIf need reset dDPSm, App close and delete user.config";
        #endregion
